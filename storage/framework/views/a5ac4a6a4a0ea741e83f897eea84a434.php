 ...
 <header id="header"><!--header-->
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                ?>
                                 <li><a href="<?php echo e(URL::to('/login_checkout')); ?>"><i class="fa fa-crosshairs"></i> Thanh toán</a></li>
                                <?php
                                 }
                                ?>
                                

                                <li><a href="<?php echo e(URL::to('/show_cart')); ?>"><i class="fa fa-shopping-cart"></i> Giỏ hàng</a></li>
                                <?php
                                   $customer_id = Session::get('customer_id');
                                   //$customer_name = Session::get('customer_name');
                                   if($customer_id!=NULL){ 
                                 ?>
                                  <li><a href="<?php echo e(URL::to('/logout_checkout')); ?>"><i class="fa fa-lock"></i> Đăng xuất </a></li>
                                ...
                                <?php
                                 ...
                                 ?>
                                 <li><a href="<?php echo e(URL::to('/admin_login')); ?>"><i class="fa fa-lock"></i> Đăng nhập</a></li>
                                 <?php 
                             }
                                 ?>
                            </ul>
    ...
    </header><!--/header--><?php /**PATH C:\xampp\htdocs\btweb\resources\views/elements/top.blade.php ENDPATH**/ ?>